> Postulat : à chaque bateau du jeu de donnée correspond une unique forme (définie par les pixels qui lui appartiennent). Deux bateau ayant la même forme désignent le même bateau.
